...
#define LOCAL_DOC_PREFIX                                                                           \
    themachinethatgoesping, echosounders, kongsbergall, filedatainterfaces, KongsbergAllEnvironmentDataInterface

template<typename T_FileStream>
void py_create_class_KongsbergAllEnvironmentDataInterfacePerFile(py::module&        m,
                                                           const std::string& CLASS_NAME)
{
    using namespace py_filetemplates::py_datainterfaces; // this holds py_i_DatagramInterface and
                                                         // py_i_DatagramInterface

    using T_BaseClass = filedatainterfaces::KongsbergAllEnvironmentDataInterfacePerFile<T_FileStream>;
...
void init_c_kongsbergallenvironmentdatainterfaceperfile(pybind11::module& m)
{

    py_create_class_KongsbergAllEnvironmentDataInterfacePerFile<std::ifstream>(
        m, "KongsbergAllEnvironmentDataInterfacePerFile");
    py_create_class_KongsbergAllEnvironmentDataInterfacePerFile<datastreams::MappedFileStream>(
        m, "KongsbergAllEnvironmentDataInterfacePerFile_mapped");
}
