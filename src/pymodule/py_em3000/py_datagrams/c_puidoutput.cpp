...
#define DOC_PUIDOutput(ARG)                                                                        \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, PUIDOutput, ARG)

void init_c_puidoutput(pybind11::module& m)
{
    py::class_<PUIDOutput, datagrams::EM3000Datagram>(
        m, "PUIDOutput", DOC(themachinethatgoesping, echosounders, em3000, datagrams, PUIDOutput))
