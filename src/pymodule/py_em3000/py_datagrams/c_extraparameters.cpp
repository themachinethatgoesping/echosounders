...
#define DOC_ExtraParameters(ARG)                                                                   \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, ExtraParameters, ARG)
...
void init_c_extraparameters(pybind11::module& m)
{
    ...
    // then add class
    py::class_<ExtraParameters, datagrams::EM3000Datagram>(
        m,
        "ExtraParameters",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, ExtraParameters))
