...
#define DOC_SurfaceSoundSpeedDatagram(ARG)                                                         \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, SurfaceSoundSpeedDatagram, ARG)

void init_c_surfacesoundspeeddatagram(pybind11::module& m)
{
    py::class_<SurfaceSoundSpeedDatagram, datagrams::EM3000Datagram>(
        m,
        "SurfaceSoundSpeedDatagram",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, SurfaceSoundSpeedDatagram))
