...
#define DOC_ExtraDetections(ARG)                                                                   \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, ExtraDetections, ARG)

void init_c_extradetections(pybind11::module& m)
{
    py::class_<ExtraDetections, datagrams::EM3000Datagram>(
        m,
        "ExtraDetections",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, ExtraDetections))
