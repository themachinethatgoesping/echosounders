...
#define DOC_SoundSpeedProfileDatagram(ARG)                                                         \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, SoundSpeedProfileDatagram, ARG)

void init_c_soundspeedprofiledatagram(pybind11::module& m)
{
    py::class_<SoundSpeedProfileDatagram, datagrams::EM3000Datagram>(
        m,
        "SoundSpeedProfileDatagram",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, SoundSpeedProfileDatagram))
