...
#define DOC_SeabedImageData(ARG)                                                                   \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, SeabedImageData, ARG)

void init_c_seabedimagedata(pybind11::module& m)
{
    py::class_<SeabedImageData, datagrams::EM3000Datagram>(
        m,
        "SeabedImageData",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, SeabedImageData))
        .def(py::init<>(), DOC_SeabedImageData(SeabedImageData))
