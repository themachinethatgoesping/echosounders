...
#define DOC_QualityFactorDatagram(ARG)                                                             \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, QualityFactorDatagram, ARG)

void init_c_qualityfactordatagram(pybind11::module& m)
{
    py::class_<QualityFactorDatagram, datagrams::EM3000Datagram>(
        m,
        "QualityFactorDatagram",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, QualityFactorDatagram))
