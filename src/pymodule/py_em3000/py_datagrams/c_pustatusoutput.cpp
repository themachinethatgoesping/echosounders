...
#define DOC_PUStatusOutput(ARG)                                                                    \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, PUStatusOutput, ARG)

void init_c_pustatusoutput(pybind11::module& m)
{
    py::class_<PUStatusOutput, datagrams::EM3000Datagram>(
        m,
        "PUStatusOutput",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, PUStatusOutput))
