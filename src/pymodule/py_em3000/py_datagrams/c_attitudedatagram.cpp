...
#define DOC_AttitudeDatagram(ARG)                                                                  \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, AttitudeDatagram, ARG)

void init_c_attitudedatagram(pybind11::module& m)
{
    py::class_<AttitudeDatagram, datagrams::EM3000Datagram>(
        m,
        "AttitudeDatagram",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, AttitudeDatagram))
