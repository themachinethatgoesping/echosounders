...
#define DOC_PositionDatagram(ARG)                                                                  \
    DOC(themachinethatgoesping, echosounders, em3000, datagrams, PositionDatagram, ARG)

void init_c_positiondatagram(pybind11::module& m)
{
    py::class_<PositionDatagram, datagrams::EM3000Datagram>(
        m,
        "PositionDatagram",
        DOC(themachinethatgoesping, echosounders, em3000, datagrams, PositionDatagram))
