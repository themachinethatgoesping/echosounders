...
void py_create_class_EM3000DatagramDataInterfacePerFile(py::module&        m,
                                                         const std::string& CLASS_NAME)
{

    using T_BaseClass = filedatainterfaces::EM3000DatagramDataInterfacePerFile<T_FileStream>;
    ...
    auto cls = py::class_<T_BaseClass, std::shared_ptr<T_BaseClass>>(
        ...
        DOC(themachinethatgoesping,
            ...
            em3000,
            filedatainterfaces,
            EM3000DatagramDataInterfacePerFile))
...
void init_c_em3000datagramdatainterfaceperfile(pybind11::module& m)
{

    py_create_class_EM3000DatagramDataInterfacePerFile<std::ifstream>(
        m, "EM3000DatagramDataInterfacePerFile");
    py_create_class_EM3000DatagramDataInterfacePerFile<datastreams::MappedFileStream>(
        m, "EM3000DatagramDataInterfacePerFile_mapped");
}
