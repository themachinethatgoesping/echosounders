...
#include "../../../themachinethatgoesping/echosounders/filetemplates/datacontainers/i_datagramcontainer.hpp"
...
{
    using filetemplates::datacontainers::I_DatagramContainer;
