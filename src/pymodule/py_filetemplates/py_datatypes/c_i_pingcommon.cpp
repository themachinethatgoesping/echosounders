    ...
    auto cls =
        py::class_<I_PingCommon, std::shared_ptr<I_PingCommon>>(
            ...
            .def("has_tx_sector_information",
                 &I_PingCommon::has_tx_sector_information,
                 DOC_I_PingCommon(has_tx_sector_information))
            ...
            .def("main_features", &I_PingCommon::main_features, DOC_I_PingCommon(main_features))
            .def("has_feature",
