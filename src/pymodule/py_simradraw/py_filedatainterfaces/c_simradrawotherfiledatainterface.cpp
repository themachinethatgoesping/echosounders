...
void init_c_simradrawotherfiledatainterface(pybind11::module& m)
{
    ...
    py_create_class_SimradRawOtherFileDataInterface<std::ifstream>(m, "SimradRawOtherFileDataInterface");
    py_create_class_SimradRawOtherFileDataInterface<datastreams::MappedFileStream>(
        m, "SimradRawOtherFileDataInterface_mapped");
}
