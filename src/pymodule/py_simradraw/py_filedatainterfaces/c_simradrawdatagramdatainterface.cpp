...
void py_create_class_SimradRawDatagramDataInterface(py::module& m, const std::string& CLASS_NAME)
{
...
void init_c_simradrawdatagramdatainterface(pybind11::module& m)
{

    py_create_class_SimradRawDatagramDataInterface<std::ifstream>(m, "SimradRawDatagramDataInterface");
    py_create_class_SimradRawDatagramDataInterface<datastreams::MappedFileStream>(
        m, "SimradRawDatagramDataInterface_mapped");
}
