...
void py_create_class_simradrawpingcommon(py::module& m, const std::string& CLASS_NAME)
{
    ...
    auto cls =
        py::class_<t_SimradRawPingCommon,
                   datatypes::I_PingCommon,
                   std::shared_ptr<t_SimradRawPingCommon>>(
            m,
            CLASS_NAME.c_str(),
...
void init_c_simradrawpingcommon(pybind11::module& m)
{
    ...
    py_create_class_simradrawpingcommon<datastreams::MappedFileStream>(m, "SimradRawPingCommon_mapped");
}
