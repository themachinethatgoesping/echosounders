...
void py_create_class_SimradEnvironmentDataInterfacePerFile(py::module&        m,
...
void init_c_simradenvironmentdatainterfaceperfile(pybind11::module& m)
{
    ...
    py_create_class_SimradEnvironmentDataInterfacePerFile<std::ifstream>(
        m, "SimradEnvironmentDataInterfacePerFile");
    py_create_class_SimradEnvironmentDataInterfacePerFile<datastreams::MappedFileStream>(
        m, "SimradEnvironmentDataInterfacePerFile_mapped");
}
