...
void py_create_class_SimradConfigurationDataInterface(py::module& m, const std::string& CLASS_NAME)
{
    ...
    using T_BaseClass = filedatainterfaces::SimradConfigurationDataInterface<T_FileStream>;
...
void init_c_SimradConfigurationDataInterface(pybind11::module& m)
{
    ...
    py_create_class_SimradConfigurationDataInterface<datastreams::MappedFileStream>(
