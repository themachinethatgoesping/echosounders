...
void py_create_class_SimradNavigationDataInterfacePerFile(py::module&        m,
...
void init_c_SimradNavigationDataInterfacePerFile(pybind11::module& m)
{
    ...
    py_create_class_SimradNavigationDataInterfacePerFile<std::ifstream>(
        m, "SimradNavigationDataInterfacePerFile");
    py_create_class_SimradNavigationDataInterfacePerFile<datastreams::MappedFileStream>(
        m, "SimradNavigationDataInterfacePerFile_mapped");
}
