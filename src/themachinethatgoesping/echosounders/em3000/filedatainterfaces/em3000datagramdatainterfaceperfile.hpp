...
#include ".docstrings/em3000datagramdatainterfaceperfile.doc.hpp"
          ...
          EM3000DatagramInterface<t_ifstream>>
{
  ...
  public:
    EM3000DatagramDataInterfacePerFile()
        : t_base("EM3000DatagramDataInterfacePerFile")
    {
    }
    ~EM3000DatagramDataInterfacePerFile() = default;
    ...
    tools::classhelper::ObjectPrinter __printer__(unsigned int float_precision)
    {
        ...
        printer.register_section("EM3000DatagramDataInterfacePerFile");
