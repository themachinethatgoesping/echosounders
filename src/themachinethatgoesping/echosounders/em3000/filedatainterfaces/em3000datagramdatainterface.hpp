...
#include ".docstrings/em3000datagramdatainterface.doc.hpp"
...
#include "em3000datagramdatainterfaceperfile.hpp"
...
class EM3000DatagramDataInterface
    : public filetemplates::datainterfaces::I_FileDataInterface<
          EM3000DatagramDataInterfacePerFile<t_ifstream>>
{
    using t_base = filetemplates::datainterfaces::I_FileDataInterface<
        EM3000DatagramDataInterfacePerFile<t_ifstream>>;

  public:
    EM3000DatagramDataInterface()
        : t_base("EM3000DatagramDataInterface")
    {
    }
    ~EM3000DatagramDataInterface() = default;
