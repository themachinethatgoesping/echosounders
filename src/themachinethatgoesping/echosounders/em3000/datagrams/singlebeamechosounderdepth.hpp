...
class SingleBeamEchoSounderDepth : public EM3000Datagram
{
  ...
  private:
    ...
    explicit SingleBeamEchoSounderDepth(EM3000Datagram header)
  ...
  public:
    ...
    {
        _datagram_identifier = t_EM3000DatagramIdentifier::SingleBeamEchoSounderDepth;
    }
    ...
    static SingleBeamEchoSounderDepth from_stream(std::istream& is, EM3000Datagram header)
    {
        ...
        if (datagram._datagram_identifier != t_EM3000DatagramIdentifier::SingleBeamEchoSounderDepth)
            throw std::runtime_error(fmt::format(
                "SingleBeamEchoSounderDepth: datagram identifier is not 0x{:02x}, but 0x{:02x}",
                uint8_t(t_EM3000DatagramIdentifier::SingleBeamEchoSounderDepth),
    ...
    tools::classhelper::ObjectPrinter __printer__(unsigned int float_precision) const
    {
        ...
        tools::classhelper::ObjectPrinter printer("SingleBeamEchoSounderDepth", float_precision);
