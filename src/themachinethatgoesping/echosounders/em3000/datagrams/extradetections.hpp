...
{
  public:
    static constexpr auto DatagramIdentifier = t_EM3000DatagramIdentifier::ExtraDetections;
  ...
  private:
    ...
    explicit ExtraDetections(EM3000Datagram header)
  ...
  public:
    // ----- public constructors -----
    ExtraDetections() { _datagram_identifier = t_EM3000DatagramIdentifier::ExtraDetections; }
        ...
        if (datagram._datagram_identifier != t_EM3000DatagramIdentifier::ExtraDetections)
            throw std::runtime_error(
                fmt::format("ExtraDetections: datagram identifier is not 0x{:02x}, but 0x{:02x}",
                            uint8_t(t_EM3000DatagramIdentifier::ExtraDetections),
    ...
    {
        tools::classhelper::ObjectPrinter printer("ExtraDetections", float_precision);
