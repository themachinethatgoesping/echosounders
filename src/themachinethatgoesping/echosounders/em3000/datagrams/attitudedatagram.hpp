 ...
 */
class AttitudeDatagram : public EM3000Datagram
{
  public:
    static constexpr auto DatagramIdentifier = t_EM3000DatagramIdentifier::AttitudeDatagram;
  ...
  private:
    ...
    explicit AttitudeDatagram(EM3000Datagram header)
  ...
  public:
    // ----- public constructors -----
    AttitudeDatagram() { _datagram_identifier = t_EM3000DatagramIdentifier::AttitudeDatagram; }
    ...
    static AttitudeDatagram from_stream(std::istream& is, EM3000Datagram header)
    {
        ...
        if (datagram._datagram_identifier != t_EM3000DatagramIdentifier::AttitudeDatagram)
            throw std::runtime_error(
                fmt::format("AttitudeDatagram: datagram identifier is not 0x{:02x}, but 0x{:02x}",
                            uint8_t(t_EM3000DatagramIdentifier::AttitudeDatagram),
