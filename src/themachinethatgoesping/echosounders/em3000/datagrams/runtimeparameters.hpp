...
{
  public:
    static constexpr auto DatagramIdentifier = t_EM3000DatagramIdentifier::RuntimeParameters;
  ...
  private:
    ...
    explicit RuntimeParameters(EM3000Datagram header)
  ...
  public:
    // ----- public constructors -----
    RuntimeParameters() { _datagram_identifier = t_EM3000DatagramIdentifier::RuntimeParameters; }
    ...
    static RuntimeParameters from_stream(std::istream& is, EM3000Datagram header)
    {
        ...
        if (datagram._datagram_identifier != t_EM3000DatagramIdentifier::RuntimeParameters)
            throw std::runtime_error(
                fmt::format("RuntimeParameters: datagram identifier is not 0x{:02x}, but 0x{:02x}",
                            uint8_t(t_EM3000DatagramIdentifier::RuntimeParameters),
