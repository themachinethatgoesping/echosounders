...
{
  public:
    static constexpr auto DatagramIdentifier = t_EM3000DatagramIdentifier::PUStatusOutput;
  ...
  private:
    ...
    explicit PUStatusOutput(EM3000Datagram header)
  ...
  public:
    // ----- public constructors -----
    PUStatusOutput() { _datagram_identifier = t_EM3000DatagramIdentifier::PUStatusOutput; }
    ...
    static PUStatusOutput from_stream(std::istream& is, EM3000Datagram header)
    {
        ...
        if (datagram._datagram_identifier != t_EM3000DatagramIdentifier::PUStatusOutput)
            throw std::runtime_error(
                fmt::format("PUStatusOutput: datagram identifier is not 0x{:02x}, but 0x{:02x}",
                            uint8_t(t_EM3000DatagramIdentifier::PUStatusOutput),
