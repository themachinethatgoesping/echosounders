...
class SoundSpeedProfileDatagram : public EM3000Datagram
{
  ...
  private:
    ...
    explicit SoundSpeedProfileDatagram(EM3000Datagram header)
  ...
  public:
    ...
    {
        _datagram_identifier = t_EM3000DatagramIdentifier::SoundSpeedProfileDatagram;
    }
    ...
    static SoundSpeedProfileDatagram from_stream(std::istream& is, EM3000Datagram header)
    {
        ...
        if (datagram._datagram_identifier != t_EM3000DatagramIdentifier::SoundSpeedProfileDatagram)
            throw std::runtime_error(fmt::format(
                "SoundSpeedProfileDatagram: datagram identifier is not 0x{:02x}, but 0x{:02x}",
                uint8_t(t_EM3000DatagramIdentifier::SoundSpeedProfileDatagram),
