...
void XML_Parameter::initialize(const pugi::xml_node& root_node)
{
...
// ----- file I/O -----
XML_Parameter XML_Parameter::from_stream(std::istream& is)
{
    XML_Parameter xml;
    size_t        size;
...
void XML_Parameter::to_stream(std::ostream& os) const
{
...
// ----- operators -----
bool XML_Parameter::operator==(const XML_Parameter& other) const
{
...
// ----- objectprinter -----
tools::classhelper::ObjectPrinter XML_Parameter::__printer__(unsigned int float_precision, bool superscript_exponents) const
{
