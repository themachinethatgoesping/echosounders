...
const XML_Configuration_Transceiver_Channel& XML_Configuration_Transceiver::get_channel(std::string_view channel_id) const
{
...
void XML_Configuration_Transceiver::initialize(const pugi::xml_node& root_node)
{
...
bool XML_Configuration_Transceiver::parsed_completely() const
{
    return unknown_children == 0 && unknown_attributes == 0;
}

XML_Configuration_Transceiver XML_Configuration_Transceiver::from_stream(std::istream& is)
{
...
void XML_Configuration_Transceiver::to_stream(std::ostream& os) const
{
...
bool XML_Configuration_Transceiver::operator==(const XML_Configuration_Transceiver& other) const
{
...
tools::classhelper::ObjectPrinter XML_Configuration_Transceiver::__printer__(unsigned int float_precision,
