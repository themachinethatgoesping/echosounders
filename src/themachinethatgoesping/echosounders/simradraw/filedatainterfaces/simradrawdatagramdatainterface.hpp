...
#include "simradrawdatagramdatainterfaceperfile.hpp"
...
class SimradRawDatagramDataInterface
    : public filetemplates::datainterfaces::I_FileDataInterface<
          SimradRawDatagramDataInterfacePerFile<t_ifstream>>
{
  ...
  public:
    SimradRawDatagramDataInterface()
        : t_base("SimradRawDatagramDataInterface")
    {
    }
    ~SimradRawDatagramDataInterface() = default;
...
template<typename t_ifstream>
tools::classhelper::ObjectPrinter SimradRawDatagramDataInterface<t_ifstream>::__printer__(unsigned int float_precision, bool superscript_exponents)
{
