...
template<typename t_ifstream>
tools::classhelper::ObjectPrinter SimradRawAnnotationDataInterfacePerFile<t_ifstream>::__printer__(unsigned int float_precision, bool superscript_exponents)
{
