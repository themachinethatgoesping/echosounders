          ...
          SimradRawConfigurationDataInterface<t_ifstream>>
{
  ...
  public:
    ...
    /**
     * @brief Read navigation data from NMEA and MRU datagrams
     * @return Navigation interpolator with all navigation data from this file
     */
...
template<typename t_ifstream>
navigation::NavigationInterpolatorLatLon SimradRawNavigationDataInterfacePerFile<t_ifstream>::read_navigation_data() const
{
...
template<typename t_ifstream>
tools::classhelper::ObjectPrinter SimradRawNavigationDataInterfacePerFile<t_ifstream>::__printer__(unsigned int float_precision, bool superscript_exponents)
{
