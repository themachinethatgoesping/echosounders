...
template<typename t_ifstream>
datagrams::xml_datagrams::XML_Configuration SimradRawConfigurationDataInterfacePerFile<t_ifstream>::get_configuration_datagram()
{
...
template<typename t_ifstream>
std::map<std::string, std::pair<datagrams::FIL1, datagrams::FIL1>> SimradRawConfigurationDataInterfacePerFile<t_ifstream>::read_fil1_datagrams()
{
...
template<typename t_ifstream>
std::vector<datagrams::xml_datagrams::XML_Configuration_Sensor> SimradRawConfigurationDataInterfacePerFile<t_ifstream>::get_position_sources()
{
    auto configuration_datagram = this->get_configuration_datagram();
    // get sensor configuration
...
template<typename t_ifstream>
std::vector<datagrams::xml_datagrams::XML_Configuration_Sensor> SimradRawConfigurationDataInterfacePerFile<t_ifstream>::get_depth_sources()
{
    auto configuration_datagram = this->get_configuration_datagram();
    // get sensor configuration
...
template<typename t_ifstream>
std::vector<datagrams::xml_datagrams::XML_Configuration_Sensor> SimradRawConfigurationDataInterfacePerFile<t_ifstream>::get_attitude_sources()
{
    auto configuration_datagram = this->get_configuration_datagram();
    // get sensor configuration
...
template<typename t_ifstream>
std::vector<datagrams::xml_datagrams::XML_Configuration_Sensor> SimradRawConfigurationDataInterfacePerFile<t_ifstream>::get_heading_sources()
{
    auto configuration_datagram = this->get_configuration_datagram();
    // get sensor configuration
...
template<typename t_ifstream>
tools::classhelper::ObjectPrinter SimradRawConfigurationDataInterfacePerFile<t_ifstream>::__printer__(unsigned int float_precision,
                                                                                                      bool         superscript_exponents)
{
