...
#include ".docstrings/kmallenvironmentdatainterface.doc.hpp"
...
#include "kmallenvironmentdatainterfaceperfile.hpp"
...
class KMALLEnvironmentDataInterface
    : public filetemplates::datainterfaces::I_EnvironmentDataInterface<
          KMALLEnvironmentDataInterfacePerFile<t_ifstream>>
{
  ...
  public:
    KMALLEnvironmentDataInterface(
        ...
        : t_base(std::move(navigation_data_interface), "KMALLEnvironmentDataInterface")
    {
    }
    ~KMALLEnvironmentDataInterface() = default;
