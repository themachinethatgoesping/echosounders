...
#include ".docstrings/kmallotherfiledatainterface.doc.hpp"
...
#include "kmallotherfiledatainterfaceperfile.hpp"
...
class KMALLOtherFileDataInterface
    : public filetemplates::datainterfaces::I_FileDataInterface<
          KMALLOtherFileDataInterfacePerFile<t_ifstream>>
{
    using t_base = filetemplates::datainterfaces::I_FileDataInterface<
        KMALLOtherFileDataInterfacePerFile<t_ifstream>>;

  public:
    KMALLOtherFileDataInterface()
        : t_base("KMALLOtherFileDataInterface")
    {
    }
    ~KMALLOtherFileDataInterface() = default;
