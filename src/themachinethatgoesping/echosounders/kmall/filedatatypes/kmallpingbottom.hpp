...
#include ".docstrings/kmallpingbottom.doc.hpp"
    ...
    , public KMALLPingCommon<t_ifstream>
{
  ...
  protected:
    std::string class_name() const override { return "KMALLPingBottom"; }

  public:
    KMALLPingBottom(std::shared_ptr<t_rawdata> file_data)
        : t_base1()
