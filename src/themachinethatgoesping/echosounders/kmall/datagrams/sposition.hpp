...
class SPosition : public KMALLSensorDatagram
{
  ...
  protected:
    uint32_t    _time_from_sensor_sec;
    uint32_t    _time_from_sensor_nanosec;
    float       _pos_fix_quality_m;
    double      _corrected_lat_deg;
    double      _corrected_lon_deg;
    float       _speed_over_ground_m_per_sec;
    float       _course_over_ground_deg;
  ...
  public:
    ...
    uint32_t get_time_from_sensor_sec() const { return _time_from_sensor_sec; }
    uint32_t get_time_from_sensor_nanosec() const { return _time_from_sensor_nanosec; }
    float    get_pos_fix_quality_m() const { return _pos_fix_quality_m; }
    double   get_corrected_lat_deg() const { return _corrected_lat_deg; }
    double   get_corrected_lon_deg() const { return _corrected_lon_deg; }
    float    get_speed_over_ground_m_per_sec() const { return _speed_over_ground_m_per_sec; }
    float    get_course_over_ground_deg() const { return _course_over_ground_deg; }
    ...
    void set_time_from_sensor_sec(uint32_t val) { _time_from_sensor_sec = val; }
    void set_time_from_sensor_nanosec(uint32_t val) { _time_from_sensor_nanosec = val; }
    void set_pos_fix_quality_m(float val) { _pos_fix_quality_m = val; }
    void set_corrected_lat_deg(double val) { _corrected_lat_deg = val; }
    void set_corrected_lon_deg(double val) { _corrected_lon_deg = val; }
    void set_speed_over_ground_m_per_sec(float val) { _speed_over_ground_m_per_sec = val; }
    void set_course_over_ground_deg(float val) { _course_over_ground_deg = val; }
