...
bool MRZPingInfo::operator==(const MRZPingInfo& other) const
{
    return (_bytes_content == other._bytes_content) && (_padding_0 == other._padding_0) &&
           ...
           (tools::helper::float_equals(_bs_correction_offset_db, other._bs_correction_offset_db)) &&
                                                               ...
                                                               bool superscript_exponents) const
    {
        ...
        printer.register_value(
            "frequency_range_high_Limit_hz", _frequency_range_high_Limit_hz, "Hz");
        printer.register_value(
            "max_total_tx_pulse_length_sec", _max_total_tx_pulse_length_sec, "s");
