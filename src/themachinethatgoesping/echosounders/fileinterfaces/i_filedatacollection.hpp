...
class I_FileDataCollection : public t_datagraminterface
{
    using t_base = t_datagraminterface;

  public:
    I_FileDataCollection(std::string_view name = "I_FileDataCollection")
        : t_base(name)
    {
    }
    virtual ~I_FileDataCollection() = default;
