...
#include ".docstrings/simradnavigationdatainterfaceperfile.doc.hpp"
          ...
          SimradConfigurationDataInterface<t_ifstream>>
{
  ...
  public:
    SimradNavigationDataInterfacePerFile()
        : t_base("SimradNavigationDataInterfacePerFile")
    {
    }
    SimradNavigationDataInterfacePerFile(
        std::shared_ptr<SimradConfigurationDataInterface<t_ifstream>> configuration_data_interface)
        : t_base(std::move(configuration_data_interface), "SimradNavigationDataInterfacePerFile")
    {
    }
    ~SimradNavigationDataInterfacePerFile() = default;
    ...
    tools::classhelper::ObjectPrinter __printer__(unsigned int float_precision)
    {
        ...
        printer.register_section("SimradNavigationDataInterfacePerFile");
