...
#include ".docstrings/simradconfigurationdatainterfaceperfile.doc.hpp"
          ...
          SimradDatagramInterface<t_ifstream>>
{
  ...
  public:
    SimradConfigurationDataInterfacePerFile()
        : t_base("SimradConfigurationDataInterfacePerFile")
    {
    }
    ~SimradConfigurationDataInterfacePerFile() = default;
    ...
    tools::classhelper::ObjectPrinter __printer__(unsigned int float_precision)
    {
        ...
        printer.register_section("SimradConfigurationDataInterfacePerFile");
