...
#include ".docstrings/simraddatagraminterface.doc.hpp"
...
class SimradDatagramInterface
    : public filetemplates::datainterfaces::I_DatagramInterface<t_SimradDatagramIdentifier,
                                                                t_ifstream>
{
  public:
    SimradDatagramInterface(std::string_view name = "SimradDatagramInterface")
        : filetemplates::datainterfaces::I_DatagramInterface<t_SimradDatagramIdentifier,
                                                             t_ifstream>(name)
    {
    }
