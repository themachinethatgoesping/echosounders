...
#include ".docstrings/s7kotherfiledatainterfaceperfile.doc.hpp"
          ...
          S7KDatagramInterface<t_ifstream>>
{
  ...
  public:
    S7KOtherFileDataInterfacePerFile()
        : t_base("S7KOtherFileDataInterfacePerFile")
    {
    }
    ~S7KOtherFileDataInterfacePerFile() = default;
                                                  ...
                                                  bool         superscript_exponents)
    {
        ...
        printer.register_section("S7KOtherFileDataInterfacePerFile");
