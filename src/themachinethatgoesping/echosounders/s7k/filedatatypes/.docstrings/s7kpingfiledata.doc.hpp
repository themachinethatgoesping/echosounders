...
static const char *mkd_doc_themachinethatgoesping_echosounders_s7k_filedatatypes_S7KPingFileData =
R"doc(Raw file data of a single s7k ping. Holds the datagram index of the
