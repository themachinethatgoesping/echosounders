...
Position Position::from_stream(std::istream& is, t_S7KDatagramIdentifier datagram_identifier)
{
...
{
    tools::classhelper::ObjectPrinter printer("Position", float_precision, superscript_exponents);
