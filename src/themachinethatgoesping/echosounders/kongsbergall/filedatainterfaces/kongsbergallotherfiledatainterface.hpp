...
#include ".docstrings/kongsbergallotherfiledatainterface.doc.hpp"
...
class KongsbergAllOtherFileDataInterface
    : public filetemplates::datainterfaces::I_FileDataInterface<
          KongsbergAllOtherFileDataInterfacePerFile<t_ifstream>>
{
    using t_base = filetemplates::datainterfaces::I_FileDataInterface<
        KongsbergAllOtherFileDataInterfacePerFile<t_ifstream>>;

  public:
    KongsbergAllOtherFileDataInterface()
        : t_base("KongsbergAllOtherFileDataInterface")
    {
    }
    ~KongsbergAllOtherFileDataInterface() = default;
