...
class ExtraDetections : public KongsbergAllDatagram
{
  ...
  public:
    ...
    uint16_t get_datagram_counter() const;
    uint16_t get_datagram_version_id() const;
    uint16_t get_swath_counter() const;
    uint16_t get_swath_index() const;
    uint16_t get_heading() const;
    uint16_t get_sound_speed() const;
    float    get_depth_of_reference_point() const;
    float    get_water_column_sample_rate() const;
    float    get_raw_amplitude_sample_rate() const;
    uint16_t get_rx_transducer_index() const;
    uint16_t get_number_of_extra_detections() const;
    uint16_t get_number_of_detection_classes() const;
    ...
    void set_datagram_counter(uint16_t datagram_counter);
    void set_datagram_version_id(uint16_t datagram_version_id);
    void set_swath_counter(uint16_t swath_counter);
    void set_swath_index(uint16_t swath_index);
