...
TEST_CASE("XML_Configuration should support common functions", TESTTAG)
{
    ...
    REQUIRE(xml1.ConfiguredSensors[1].X == Approx(5.32));
    REQUIRE(xml1.ConfiguredSensors[1].Y == Approx(-2.02));
    REQUIRE(xml1.ConfiguredSensors[1].Z == Approx(-24.36));
    ...
    REQUIRE(xml1.ConfiguredSensors[2].X == Approx(0.0));
    REQUIRE(xml1.ConfiguredSensors[2].Y == Approx(0.0));
    REQUIRE(xml1.ConfiguredSensors[2].Z == Approx(0.0));
    ...
    REQUIRE(xml1.Transducers[0].TransducerAlphaX == Approx(-0.5));
    REQUIRE(xml1.Transducers[0].TransducerAlphaY == Approx(1.5));
    REQUIRE(xml1.Transducers[0].TransducerAlphaZ == Approx(0.5));
    REQUIRE(xml1.Transducers[0].TransducerOffsetX == Approx(7.88));
    REQUIRE(xml1.Transducers[0].TransducerOffsetY == Approx(1.09));
    REQUIRE(xml1.Transducers[0].TransducerOffsetZ == Approx(5.87));
    ...
    CHECK(xml1.Transducers[1].TransducerAlphaX == Approx(0.6));
    CHECK(xml1.Transducers[1].TransducerAlphaY == Approx(1.0));
    CHECK(xml1.Transducers[1].TransducerAlphaZ == Approx(0.0));
    CHECK(xml1.Transducers[1].TransducerOffsetX == Approx(8.22));
    CHECK(xml1.Transducers[1].TransducerOffsetY == Approx(1.47));
    CHECK(xml1.Transducers[1].TransducerOffsetZ == Approx(5.88));
    ...
    CHECK(xml1.Transducers[2].TransducerAlphaX == Approx(-0.5));
    CHECK(xml1.Transducers[2].TransducerAlphaY == Approx(0.9));
    CHECK(xml1.Transducers[2].TransducerAlphaZ == Approx(0.2));
    CHECK(xml1.Transducers[2].TransducerOffsetX == Approx(8.27));
    CHECK(xml1.Transducers[2].TransducerOffsetY == Approx(1.17));
    CHECK(xml1.Transducers[2].TransducerOffsetZ == Approx(5.87));
    ...
    CHECK(xml1.Transducers[3].TransducerAlphaX == Approx(-1.2));
    CHECK(xml1.Transducers[3].TransducerAlphaY == Approx(0.9));
    CHECK(xml1.Transducers[3].TransducerAlphaZ == Approx(0.4));
    CHECK(xml1.Transducers[3].TransducerOffsetX == Approx(8.22));
    CHECK(xml1.Transducers[3].TransducerOffsetY == Approx(0.94));
    CHECK(xml1.Transducers[3].TransducerOffsetZ == Approx(5.88));
    ...
    REQUIRE(xml1.Transceivers[0].RxSampleFrequency == Approx(1500000));
    ...
    REQUIRE(xml1.Transceivers[0].Channels[0].MaxTxPowerTransceiver == Approx(2000));
    ...
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.BeamType ==
            themachinethatgoesping::echosounders::simrad::datagrams::xml_datagrams::t_BeamType::
                BeamTypeSplit3CN);
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.Frequency == Approx(38000.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.FrequencyMinimum == Approx(34000.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.FrequencyMaximum == Approx(45000.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.EquivalentBeamAngle == Approx(-20.7));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.MaxTxPowerTransducer == Approx(2000.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.BeamWidthAlongship == Approx(7.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.BeamWidthAthwartship == Approx(7.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.AngleSensitivityAlongship == Approx(18.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.AngleSensitivityAthwartship ==
            Approx(18.00));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.AngleOffsetAlongship == Approx(0.0));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.AngleOffsetAthwartship == Approx(0.0));
    ...
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.FrequencyPars[100].Frequency ==
            Approx(43909));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.FrequencyPars[100].Gain == Approx(28.29));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.FrequencyPars[100].Impedance ==
            Approx(75.0));
    REQUIRE(xml1.Transceivers[0].Channels[0].Transducer.FrequencyPars[100].Phase == Approx(0.));
