...
void init_c_xml_parameter_channel(nanobind::module_& m)
{
    nb::class_<XML_Parameter_Channel>(m,
                                      "XML_Parameter_Channel",
                                      DOC(themachinethatgoesping,
                                          echosounders,
                                          simradraw,
                                          ...
                                          xml_datagrams,
                                          XML_Parameter_Channel))
        .def(nb::init<>(), DOC_XML_Parameter_Channel(XML_Parameter_Channel))
