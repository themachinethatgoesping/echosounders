...
#define DOC_FIL1(arg) DOC(themachinethatgoesping, echosounders, simradraw, datagrams, FIL1, arg)

void init_c_FIL1(nanobind::module_& m)
{

    nb::class_<FIL1, datagrams::SimradRawDatagram>(
        m, "FIL1", DOC(themachinethatgoesping, echosounders, simradraw, datagrams, FIL1))
        .def(nb::init<>(), DOC_FIL1(FIL1))
