...
void init_c_XML0(nanobind::module_& m)
{
    nb::class_<XML0, datagrams::SimradRawDatagram>(
        m, "XML0", DOC(themachinethatgoesping, echosounders, simradraw, datagrams, XML0))
        .def(nb::init<>(), DOC_XML0(XML0))
        ...
        // ----- operators -----
        .def("__eq__", &XML0::operator==, DOC_XML0(operator_eq), nb::arg("other"))
        // ----- pybind macros -----
