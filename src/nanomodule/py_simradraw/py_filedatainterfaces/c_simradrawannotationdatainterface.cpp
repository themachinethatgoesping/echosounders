...
void py_create_class_SimradRawAnnotationDataInterface(nb::module_& m, const std::string& CLASS_NAME)
{
    ...
    // cls __PYCLASS_DEFAULT_PRINTING__(SimradRawAnnotationDataInterface<T_FileStream>);
}

void init_c_simradrawannotationdatainterface(nanobind::module_& m)
{
