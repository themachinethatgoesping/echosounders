...
void py_create_class_simradrawpingdatainterface(nb::module_& m, const std::string& CLASS_NAME)
{
    using py_filetemplates::py_datainterfaces::py_i_pingdatainterface::
        PingDataInterface_add_interface;
    using T_BaseClass = filedatainterfaces::SimradRawPingDataInterface<T_FileStream>;
...
void init_c_simradrawpingdatainterface(nanobind::module_& m)
{
