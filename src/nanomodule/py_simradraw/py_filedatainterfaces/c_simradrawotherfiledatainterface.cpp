...
void py_create_class_SimradRawOtherFileDataInterface(nb::module_& m, const std::string& CLASS_NAME)
{
...
void init_c_simradrawotherfiledatainterface(nanobind::module_& m)
{
