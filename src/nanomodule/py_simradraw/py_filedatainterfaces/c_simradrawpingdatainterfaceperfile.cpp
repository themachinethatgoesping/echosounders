...
void py_create_class_simradrawpingdatainterfacePerFile(nb::module_& m, const std::string& CLASS_NAME)
{
...
void init_c_simradrawpingdatainterfaceperfile(nanobind::module_& m)
{
