...
void init_c_skmbinary(nanobind::module_& m)
{
    ...
    nb::enum_<t_sensor_format>(m, "SKMBinary_t_sensor_format", DOC_SKMBinary(t_sensor_format))
        ...
        .value("EM_3000_data",
               ...
               DOC_SKMBinarySensorFormat(EM_3000_data))
    ...
    nb::class_<SKMBinary, datagrams::KMALLDatagram>(
        ...
        .def("get_bytes_content",
             &SKMBinary::get_bytes_content,
             DOC_SKMBinary(get_bytes_content))
        .def("get_sensor_system",
             &SKMBinary::get_sensor_system,
             DOC_SKMBinary(get_sensor_system))
        .def("get_sensor_status",
             &SKMBinary::get_sensor_status,
             DOC_SKMBinary(get_sensor_status))
        .def("get_sensor_format",
             &SKMBinary::get_sensor_format,
             DOC_SKMBinary(get_sensor_format))
        ...
        .def("__eq__",
             &SKMBinary::operator==,
             DOC_SKMBinary(operator_eq),
             nb::arg("other"))

        // ----- pybind macros -----
        __PYCLASS_DEFAULT_COPY__(SKMBinary)
        __PYCLASS_DEFAULT_BINARY__(SKMBinary)
