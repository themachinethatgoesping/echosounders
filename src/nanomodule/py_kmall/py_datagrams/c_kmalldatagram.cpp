...
void init_c_kmalldatagram(nanobind::module_& m)
{
    nb::class_<KMALLDatagram>(
        ...
        .def("get_bytes_datagram",
             ...
             DOC_KMALLDatagram(bytes_datagram))
        .def("set_bytes_datagram",
             &KMALLDatagram::set_bytes_datagram,
             DOC_KMALLDatagram(bytes_datagram),
             nb::arg("bytes_datagram"))
        .def("get_datagram_version", &KMALLDatagram::get_datagram_version, DOC_KMALLDatagram(datagram_version))
        .def("set_datagram_version",
             &KMALLDatagram::set_datagram_version,
             DOC_KMALLDatagram(datagram_version),
             nb::arg("datagram_version"))
        .def("get_system_id", &KMALLDatagram::get_system_id, DOC_KMALLDatagram(system_id))
        .def("set_system_id",
             &KMALLDatagram::set_system_id,
             DOC_KMALLDatagram(system_id),
             nb::arg("system_id"))
        .def("get_echo_sounder_id",
             &KMALLDatagram::get_echo_sounder_id,
             DOC_KMALLDatagram(echo_sounder_id))
        .def("set_echo_sounder_id",
             &KMALLDatagram::set_echo_sounder_id,
             DOC_KMALLDatagram(echo_sounder_id),
             nb::arg("echo_sounder_id"))
        .def("get_time_sec", &KMALLDatagram::get_time_sec, DOC_KMALLDatagram(time_sec))
        .def("set_time_sec",
             &KMALLDatagram::set_time_sec,
             DOC_KMALLDatagram(time_sec),
             nb::arg("time_sec"))
        .def("get_time_nanosec",
             &KMALLDatagram::get_time_nanosec,
             DOC_KMALLDatagram(time_nanosec))
        ...
        .def("set_datagram_identifier",
             ...
             DOC_KMALLDatagram(datagram_identifier),
