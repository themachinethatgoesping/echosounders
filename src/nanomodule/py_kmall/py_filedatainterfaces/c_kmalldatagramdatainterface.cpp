...
void py_create_class_KMALLDatagramDataInterface(nanobind::module_& m,
                                                       const std::string& CLASS_NAME)
{
    using py_filetemplates::py_datainterfaces::py_i_filedatainterface::
        FileDataInterface_add_interface;

    using T_BaseClass = filedatainterfaces::KMALLDatagramDataInterface<T_FileStream>;
...
void init_c_kmalldatagramdatainterface(nanobind::module_& m)
{
    static const std::string name        = "KMALLDatagramDataInterface";
    static const std::string name_stream = name + "_stream";
    static const std::string name_mapped = name + "";

    py_create_class_KMALLDatagramDataInterface<std::ifstream>(m, name_stream);
    py_create_class_KMALLDatagramDataInterface<datastreams::MappedFileStream>(m,
                                                                                     name_mapped);
}
