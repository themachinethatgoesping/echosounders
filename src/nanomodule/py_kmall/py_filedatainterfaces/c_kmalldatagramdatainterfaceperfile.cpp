...
#include <themachinethatgoesping/echosounders/kmall/filedatainterfaces/kmalldatagramdatainterface.hpp>
...
void py_create_class_KMALLDatagramDataInterfacePerFile(nanobind::module_& m,
                                                              const std::string& CLASS_NAME)
{

    using T_BaseClass = filedatainterfaces::KMALLDatagramDataInterfacePerFile<T_FileStream>;
...
void init_c_kmalldatagramdatainterfaceperfile(nanobind::module_& m)
{
    static const std::string name        = "KMALLDatagramDataInterfacePerFile";
    static const std::string name_stream = name + "_stream";
    static const std::string name_mapped = name + "";

    py_create_class_KMALLDatagramDataInterfacePerFile<std::ifstream>(m, name_stream);
    py_create_class_KMALLDatagramDataInterfacePerFile<datastreams::MappedFileStream>(
        m, name_mapped);
}
