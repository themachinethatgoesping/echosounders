...
void py_create_class_kmallpingdatainterface(nanobind::module_& m,
                                                   const std::string& CLASS_NAME)
{
    using py_filetemplates::py_datainterfaces::py_i_pingdatainterface::
        PingDataInterface_add_interface;
    using T_BaseClass = filedatainterfaces::KMALLPingDataInterface<T_FileStream>;
...
void init_c_kmallpingdatainterface(nanobind::module_& m)
{
    static const std::string name        = "KMALLPingDataInterface";
    static const std::string name_stream = name + "_stream";
    static const std::string name_mapped = name + "";

    py_create_class_kmallpingdatainterface<std::ifstream>(m, name_stream);
    py_create_class_kmallpingdatainterface<datastreams::MappedFileStream>(m, name_mapped);
}
