...
#define DOC_KMALLPing(ARG)                                                                         \
    DOC(themachinethatgoesping, echosounders, kmall, filedatatypes, KMALLPingWatercolumn, ARG)
...
void py_create_class_kmallpingwatercolumn(nanobind::module_& m, const std::string& CLASS_NAME)
{
    ...
    auto cls =
        nb::class_<t_KMALLPingWatercolumn, datatypes::I_PingWatercolumn>(
            m,
            CLASS_NAME.c_str(),
            DOC(themachinethatgoesping, echosounders, kmall, filedatatypes, KMALLPingWatercolumn))
            ...
            .def("get_raw_amplitudes",
                 nb::overload_cast<>(&t_KMALLPingWatercolumn::template get_raw_amplitudes<int8_t>),
            ...
            .def("get_raw_amplitudes_float",
                 nb::overload_cast<>(&t_KMALLPingWatercolumn::template get_raw_amplitudes<float>),
                 DOC_KMALLPing(get_raw_amplitudes))
            .def("get_raw_amplitudes_float",
                 nb::overload_cast<const pingtools::BeamSampleSelection&>(
