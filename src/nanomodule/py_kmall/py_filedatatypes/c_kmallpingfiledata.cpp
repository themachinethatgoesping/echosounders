...
void py_create_class_kmallPingFileData(nanobind::module_& m, const std::string& CLASS_NAME)
{
    ...
    using namespace themachinethatgoesping::echosounders::kmall::filedatatypes::calibration;
     ...
     auto cls = nb::class_<t_KMALLPingFileData,
               ...
               //                nb::overload_cast<
               //              const filedatatypes::calibration::KMALLWaterColumnCalibration&>(
               ...
               //              filedatatypes::calibration::KMALLWaterColumnCalibration>&>(
               //              &t_KMALLPingFileData::set_watercolumn_calibration),
               //          DOC_KMALLPingFileData(set_watercolumn_calibration_2),
               //                nb::arg("calibrations"))
               //     .def("get_watercolumn_calibration",
               //                nb::overload_cast<size_t>(
               //                     &t_KMALLPingFileData::get_watercolumn_calibration, nb::const_),
               ...
               //     .def("wci_loaded",
               //          &t_KMALLPingFileData::wci_loaded,
               //          DOC_KMALLPingFileData(wci_loaded))
               //     .def("sys_loaded",
               //          &t_KMALLPingFileData::sys_loaded,
               //          DOC_KMALLPingFileData(sys_loaded))
    ...
    py_filedatainterfaces::KMALLDatagramInterface_add_interface_functions<
        t_KMALLPingFileData>(cls);
}
