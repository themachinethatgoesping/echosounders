...
void py_create_class_KongsbergAllAnnotationDataInterfacePerFile(nanobind::module_& m,
...
void init_c_kongsbergallannotationdatainterfaceperfile(nanobind::module_& m)
{
    ...
    py_create_class_KongsbergAllAnnotationDataInterfacePerFile<std::ifstream>(m, name_stream);
