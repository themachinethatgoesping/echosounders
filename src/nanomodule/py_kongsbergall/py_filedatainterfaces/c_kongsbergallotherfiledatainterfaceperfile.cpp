...
void py_create_class_KongsbergAllOtherFileDataInterfacePerFile(nanobind::module_& m,
...
void init_c_kongsbergallotherfiledatainterfaceperfile(nanobind::module_& m)
{
