...
void py_create_class_KongsbergAllNavigationDataInterfacePerFile(nanobind::module_& m,
...
void init_c_kongsbergallnavigationdatainterfaceperfile(nanobind::module_& m)
{
