...
void py_create_class_KongsbergAllDatagramDataInterfacePerFile(nanobind::module_& m,
...
void init_c_kongsbergalldatagramdatainterfaceperfile(nanobind::module_& m)
{
