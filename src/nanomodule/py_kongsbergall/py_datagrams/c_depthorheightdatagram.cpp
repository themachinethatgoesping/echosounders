...
void init_c_depthorheightdatagram(nanobind::module_& m)
{
     nb::class_<DepthOrHeightDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "DepthOrHeightDatagram",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, DepthOrHeightDatagram))
     .def(nb::init<>(), DOC_DepthOrHeightDatagram(DepthOrHeightDatagram))
