...
#include "../../../themachinethatgoesping/echosounders/kongsbergall/datagrams/headingdatagram.hpp"
...
#define DOC_HeadingDatagram(ARG)                                                                   \
    DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, HeadingDatagram, ARG)

void init_c_headingdatagram(nanobind::module_& m)
{
     nb::class_<HeadingDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "HeadingDatagram",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, HeadingDatagram))
     .def(nb::init<>(), DOC_HeadingDatagram(HeadingDatagram))
