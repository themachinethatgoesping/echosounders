...
void init_c_rawrangeandangletransmitsector(nanobind::module_& m)
{

     nb::class_<RawRangeAndAngleTransmitSector>(m,
                                               "RawRangeAndAngleTransmitSector",
                                               DOC(themachinethatgoesping,
                                                   echosounders,
                                                   kongsbergall,
                                                   ...
                                                   substructures,
                                                   RawRangeAndAngleTransmitSector))
     .def(nb::init<>(), DOC_RawRangeAndAngleTransmitSector(RawRangeAndAngleTransmitSector))
