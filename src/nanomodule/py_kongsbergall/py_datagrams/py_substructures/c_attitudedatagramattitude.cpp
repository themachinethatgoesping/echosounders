...
void init_c_attitudedatagramattitude(nanobind::module_& m)
{

     nb::class_<AttitudeDatagramAttitude>(m,
                                         "AttitudeDatagramAttitude",
                                         DOC(themachinethatgoesping,
                                             echosounders,
                                             kongsbergall,
                                             ...
                                             substructures,
                                             AttitudeDatagramAttitude))
     .def(nb::init<>(), DOC_AttitudeDatagramAttitude(AttitudeDatagramAttitude))
