...
#include "../../../../themachinethatgoesping/echosounders/kongsbergall/datagrams/substructures/watercolumndatagramtransmitsector.hpp"
...
void init_c_watercolumndatagramtransmitsector(nanobind::module_& m)
{

     nb::class_<WatercolumnDatagramTransmitSector>(m,
                                                  "WatercolumnDatagramTransmitSector",
                                                  DOC(themachinethatgoesping,
                                                      echosounders,
                                                      kongsbergall,
                                                      ...
                                                      substructures,
                                                      WatercolumnDatagramTransmitSector))
     .def(nb::init<>(), DOC_WatercolumnDatagramTransmitSector(WatercolumnDatagramTransmitSector))
