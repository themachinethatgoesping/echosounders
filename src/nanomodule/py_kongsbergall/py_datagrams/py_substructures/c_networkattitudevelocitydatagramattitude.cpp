...
void init_c_networkattitudevelocitydatagramattitude(nanobind::module_& m)
{

     nb::class_<NetworkAttitudeVelocityDatagramAttitude>(
        m,
        "NetworkAttitudeVelocityDatagramAttitude",
        DOC(themachinethatgoesping,
            echosounders,
        ...
        .def("set_input_datagram",
          ...
          .def(
               ...
               [](const NetworkAttitudeVelocityDatagramAttitude& self) {
                    const auto& payload = self.get_input_datagram();
