...
void init_c_extradetectionsextradetections(nanobind::module_& m)
{

     nb::class_<ExtraDetectionsExtraDetections>(m,
                                               "ExtraDetectionsExtraDetections",
                                               DOC(themachinethatgoesping,
                                                   echosounders,
                                                   kongsbergall,
                                                   ...
                                                   substructures,
                                                   ExtraDetectionsExtraDetections))
     .def(nb::init<>(), DOC_ExtraDetectionsExtraDetections(ExtraDetectionsExtraDetections))
