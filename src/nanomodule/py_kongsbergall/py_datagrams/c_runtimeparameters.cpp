...
void init_c_runtimeparameters(nanobind::module_& m)
{
     nb::class_<RuntimeParameters, datagrams::KongsbergAllDatagram>(
        m,
        "RuntimeParameters",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, RuntimeParameters))
     .def(nb::init<>(), DOC_RuntimeParameters(RuntimeParameters))
        ...
        .def("get_mode_as_ping_mode",
             ...
             nb::arg("unhandled_message") = std::nullopt)
        ...
        .def("get_mode2_as_receive_fixed_gain_setting_dB",
             ...
             nb::arg("unhandled_value") = std::nullopt)
