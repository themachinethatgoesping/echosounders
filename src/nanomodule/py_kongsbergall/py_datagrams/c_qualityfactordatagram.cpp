...
void init_c_qualityfactordatagram(nanobind::module_& m)
{
     nb::class_<QualityFactorDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "QualityFactorDatagram",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, QualityFactorDatagram))
     .def(nb::init<>(), DOC_QualityFactorDatagram(QualityFactorDatagram))
