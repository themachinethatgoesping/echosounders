...
void init_c_watercolumndatagram(nanobind::module_& m)
{
     nb::class_<WatercolumnDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "WatercolumnDatagram",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, WatercolumnDatagram))
     .def(nb::init<>(), DOC_WatercolumnDatagram(WatercolumnDatagram))
