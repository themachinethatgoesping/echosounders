...
#include "../../../themachinethatgoesping/echosounders/kongsbergall/datagrams/networkattitudevelocitydatagram.hpp"
...
void init_c_networkattitudevelocitydatagram(nanobind::module_& m)
{
     nb::class_<NetworkAttitudeVelocityDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "NetworkAttitudeVelocityDatagram",
        DOC(themachinethatgoesping,
            echosounders,
            ...
            datagrams,
            NetworkAttitudeVelocityDatagram))
     .def(nb::init<>(), DOC_NetworkAttitudeVelocityDatagram(NetworkAttitudeVelocityDatagram))
