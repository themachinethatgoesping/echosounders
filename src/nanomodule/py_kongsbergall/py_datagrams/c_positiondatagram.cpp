...
void init_c_positiondatagram(nanobind::module_& m)
{
     nb::class_<PositionDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "PositionDatagram",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, PositionDatagram))
     .def(nb::init<>(), DOC_PositionDatagram(PositionDatagram))
