...
void init_c_singlebeamechosounderdepth(nanobind::module_& m)
{
     nb::class_<SingleBeamEchoSounderDepth, datagrams::KongsbergAllDatagram>(
        m,
        "SingleBeamEchoSounderDepth",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, SingleBeamEchoSounderDepth))
     .def(nb::init<>(), DOC_SingleBeamEchoSounderDepth(SingleBeamEchoSounderDepth))
