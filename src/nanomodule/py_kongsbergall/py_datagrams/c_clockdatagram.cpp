...
#define DOC_ClockDatagram(ARG)                                                                     \
    DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, ClockDatagram, ARG)

void init_c_clockdatagram(nanobind::module_& m)
{
     nb::class_<ClockDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "ClockDatagram",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, ClockDatagram))
     .def(nb::init<>(), DOC_ClockDatagram(ClockDatagram))
