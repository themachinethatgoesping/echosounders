...
void init_c_attitudedatagram(nanobind::module_& m)
{
     nb::class_<AttitudeDatagram, datagrams::KongsbergAllDatagram>(
        m,
        "AttitudeDatagram",
        DOC(themachinethatgoesping, echosounders, kongsbergall, datagrams, AttitudeDatagram))
          .def(nb::init<>(), DOC_AttitudeDatagram(AttitudeDatagram))
