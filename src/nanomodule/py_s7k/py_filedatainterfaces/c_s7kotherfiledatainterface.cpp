...
#define LOCAL_DOC_PREFIX                                                                            \
    themachinethatgoesping, echosounders, s7k, filedatainterfaces, S7KOtherFileDataInterface

template<typename T_FileStream>
void py_create_class_S7KOtherFileDataInterface(nanobind::module_& m, const std::string& CLASS_NAME)
{
    using py_filetemplates::py_datainterfaces::py_i_filedatainterface::FileDataInterface_add_interface;

    using T_BaseClass = filedatainterfaces::S7KOtherFileDataInterface<T_FileStream>;
...
{
    static const std::string name        = "S7KOtherFileDataInterface";
    static const std::string name_stream = name + "_stream";
    static const std::string name_mapped = name + "";

    py_create_class_S7KOtherFileDataInterface<std::ifstream>(m, name_stream);
    py_create_class_S7KOtherFileDataInterface<datastreams::MappedFileStream>(m, name_mapped);
}
