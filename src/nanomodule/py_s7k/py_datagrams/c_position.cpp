...
void init_c_position(nb::module_& m)
{
    nb::class_<Position, S7KDatagram>(m, "Position", DOC(themachinethatgoesping, echosounders, s7k, datagrams, Position))
        ...
        .def("get_datum", &Position::get_datum, DOC_C(Position, Content, datum))
        .def("set_datum", &Position::set_datum, DOC_C(Position, Content, datum), nb::arg("val"))
        ...
        .def("get_latitude_northing", &Position::get_latitude_northing, DOC_C(Position, Content, latitude_northing))
        .def("set_latitude_northing", &Position::set_latitude_northing, DOC_C(Position, Content, latitude_northing), nb::arg("val"))
        .def("get_longitude_easting", &Position::get_longitude_easting, DOC_C(Position, Content, longitude_easting))
        .def("set_longitude_easting", &Position::set_longitude_easting, DOC_C(Position, Content, longitude_easting), nb::arg("val"))
        ...
        .def("get_position_type", &Position::get_position_type, DOC_C(Position, Content, position_type))
        .def("set_position_type", &Position::set_position_type, DOC_C(Position, Content, position_type), nb::arg("val"))
        ...
        .def("get_quality", &Position::get_quality, DOC_C(Position, Content, quality))
        .def("set_quality", &Position::set_quality, DOC_C(Position, Content, quality), nb::arg("val"))
