...
void init_c_beamgeometry(nb::module_& m)
{
    nb::class_<BeamGeometry, S7KDatagram>(
        ...
        .def("get_beam_vertical_angle_in_degrees", &BeamGeometry::get_beam_vertical_angle_in_degrees, DOC_C(BeamGeometry, get_beam_vertical_angle_in_degrees))
        .def("get_beam_horizontal_angle_in_degrees", &BeamGeometry::get_beam_horizontal_angle_in_degrees, DOC_C(BeamGeometry, get_beam_horizontal_angle_in_degrees))
        .def("get_beamwidth_vertical_in_degrees", &BeamGeometry::get_beamwidth_vertical_in_degrees, DOC_C(BeamGeometry, get_beamwidth_vertical_in_degrees))
        .def("get_beamwidth_horizontal_in_degrees", &BeamGeometry::get_beamwidth_horizontal_in_degrees, DOC_C(BeamGeometry, get_beamwidth_horizontal_in_degrees))
        ...
        .def("get_checksum", &BeamGeometry::get_checksum, DOC_C(BeamGeometry, checksum))
        .def("set_checksum", &BeamGeometry::set_checksum, DOC_C(BeamGeometry, checksum), nb::arg("val"))
