...
void init_c_rollpitchheave(nb::module_& m)
{
    nb::class_<RollPitchHeave, S7KDatagram>(m, "RollPitchHeave", DOC(themachinethatgoesping, echosounders, s7k, datagrams, RollPitchHeave))
        ...
        .def("get_roll", &RollPitchHeave::get_roll, DOC_C(RollPitchHeave, Content, roll))
        .def("set_roll", &RollPitchHeave::set_roll, DOC_C(RollPitchHeave, Content, roll), nb::arg("val"))
        .def("get_pitch", &RollPitchHeave::get_pitch, DOC_C(RollPitchHeave, Content, pitch))
